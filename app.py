...
if selected_model == "Freight Cost Prediction":
    ...
    st.markdown("**Objective:** Predict freight cost for budgeting and forecasting.")
    ...
    st.markdown("**Objective:** Detect if an invoice should be flagged for manual approval.")
